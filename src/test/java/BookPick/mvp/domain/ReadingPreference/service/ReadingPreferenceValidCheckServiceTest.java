...
class ReadingPreferenceValidCheckServiceTest {
    ...
    @InjectMocks
    private ReadingPreferenceValidCheckService validCheckService;
    ...
    void validateReadingPreferenceReq_nullOrEmptyMbti_success() {
        // given
        ReadingPreferenceReq req1 = new ReadingPreferenceReq(
                null,
                Set.of(),
                Set.of(),
                List.of("차분한"),
        ...
        ReadingPreferenceReq req2 = new ReadingPreferenceReq(
                "",
                Set.of(),
                Set.of(),
                List.of("차분한"),
