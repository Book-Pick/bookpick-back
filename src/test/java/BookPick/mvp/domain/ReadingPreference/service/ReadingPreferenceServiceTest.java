...
class ReadingPreferenceServiceTest {
    ...
    @Mock
    private ReadingPreferenceRepository readingPreferenceRepository;
    ...
    @Mock
    private ReadingPreferenceValidCheckService readingPreferenceValidCheckService;
    ...
    void addReadingPreference_success() {
        ...
        ReadingPreferenceReq req = new ReadingPreferenceReq(
                "INTJ",
                Set.of(bookDto),
                Set.of(authorDto),
                List.of("차분한"),
        ...
        ReadingPreference mockPreference = ReadingPreference.builder()
                .user(mockUser)
                .mbti("INTJ")
        ...
        when(readingPreferenceRepository.save(any(ReadingPreference.class))).thenReturn(mockPreference);
    ...
    void findReadingPreference_success() {
        ...
        when(userRepository.findById(userId)).thenReturn(Optional.of(mockUser));
        when(readingPreferenceRepository.findByUserId(userId)).thenReturn(Optional.of(mockPreference));
    ...
    void removeReadingPreference_success() {
        ...
        // when
        ReadingPreferenceDeleteRes result = readingPreferenceService.removeReadingPreference(userId);
