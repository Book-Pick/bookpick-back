...
class LogoutControllerTest {
    ...
    void logout_success() throws Exception {
        ...
        doNothing().when(logoutService).logout(any(), any(HttpServletRequest.class), any(HttpServletResponse.class));
        ...
        verify(logoutService).logout(any(), any(HttpServletRequest.class), any(HttpServletResponse.class));
    }
    ...
    void logout_fail_notAuthenticated() throws Exception {
        ...
        doThrow(new NotAuthenticateUser())
                .when(logoutService).logout(any(), any(HttpServletRequest.class), any(HttpServletResponse.class));
    ...
    void logout_serviceInvoked() throws Exception {
        ...
        // then
        verify(logoutService, times(1)).logout(any(), any(HttpServletRequest.class), any(HttpServletResponse.class));
    }
    ...
    void logout_multipleUsers() throws Exception {
        ...
        verify(logoutService, times(2)).logout(any(), any(HttpServletRequest.class), any(HttpServletResponse.class));
    }
}
