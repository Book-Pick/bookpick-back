...
class CurationDeleteServiceTest {
    ...
    @InjectMocks
    private CurationDeleteService curationDeleteService;
    ...
    void removeCurations_success() {
        ...
        Curation curation3 = Curation.builder()
                .id(3L)
                .user(mockUser)
                .title("큐레이션 3")
                .isDrafted(true)
    ...
    void removeCurations_containsOthersPost_fail() {
        ...
        Curation myCuration = Curation.builder()
                .id(1L)
                .user(mockUser)
                .title("내 큐레이션")
                .isDrafted(false)
        ...
        Curation otherCuration = Curation.builder()
                .id(2L)
                .user(otherUser)
                .title("다른 사람 큐레이션")
                .isDrafted(false)
