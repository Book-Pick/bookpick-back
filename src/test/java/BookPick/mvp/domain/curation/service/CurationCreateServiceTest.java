...
class CurationCreateServiceTest {
    ...
    @InjectMocks
    private CurationCreateService curationCreateService;
    ...
    void publishCuration_success() {
        ...
        CurationReq req = new CurationReq(
                "테스트 큐레이션",
    ...
    void createCuration_publishVsDraft() {
        ...
        // when - 발행
        CurationReq publishReq = new CurationReq(
                "발행", new ThumbnailDto("t.jpg", "#FFF"),
                new BookDto("책", "작가", "123", "b.jpg"), "리뷰",
                new RecommendDto(List.of(), List.of(), List.of(), List.of()),
                false
        );
        ...
        // when - 임시저장
        CurationReq draftReq = new CurationReq(
                "임시", new ThumbnailDto("t.jpg", "#FFF"),
                new BookDto("책", "작가", "123", "b.jpg"), "리뷰",
                new RecommendDto(List.of(), List.of(), List.of(), List.of()),
                true
        );
