...
public record CurationListGetRes(
        ...
        boolean hasNext,
        Long nextCursor) {
    public static CurationListGetRes from(
            SortType sortType, List<CurationContentRes> content, boolean hasNext, Long nextCursor) {
    ...
    public static CurationListGetRes ofEmpty(SortType sortType) {
        return new CurationListGetRes(
                sortType.getValue(), sortType.getDescription(), new ArrayList<>(), 0, false, null);
    }
}
