...
public enum UserErrorCode implements ErrorCodeInterface {
    ...
    USER_NAME_IS_NULL(HttpStatus.BAD_REQUEST, "닉네임은 비어있으면 안됩니다."),
    ALREADY_DELETE_USR(
            HttpStatus.CONFLICT, "이미 삭제한 유저입니다."), // 409, 이미 삭제한 유저기때문에 conflict 충돌이라는 의미
    PASSWORD_MISMATCH(
            HttpStatus.BAD_REQUEST,
            "변경할 비밀번호와 확인 비밀번호가 일치하지 않습니다."), // 409, 이미 삭제한 유저기때문에 conflict 충돌이라는 의미
